...
- Presets는 “촬영 레시피를 고르는 곳”, Gallery는 “결과 감성을 보고 조합을 고르는 곳”으로 이해되도록 상단 설명 문구를 수정했습니다.
- Home 우측 비주얼은 새로 생성한 필름 가이드 콜라주 이미지로 교체했습니다.
...
```text
잘못된 구조:
repository/film-prompt-studio-v16/index.html
